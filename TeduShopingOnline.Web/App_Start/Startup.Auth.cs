...
namespace TeduShopingOnline.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(TeduShoppingOnlineDbContext.Create);
        ...
        public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
        {
            ...
            public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        context.Rejected();
                        context.SetError("invalid_group", "You are not an admin.");
                    }
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<TeduShoppingOnlineDbContext>());
